...
Examples:
  ...
  stock-analysis app
    ...
    # Features command
    features_parser = subparsers.add_parser('features', help='Run feature engineering analysis')
    features_parser.add_argument('symbol', help='Stock symbol')
    features_parser.add_argument(
        '--output-dir', default='./feature_analysis',
...
def run_app(args):
    ...
    try:
        ...
        streamlit_path = Path(__file__).parent.parent.parent / "src" / "streamlit_app" / "Home.py"
